 ...
 * Checks to see that commandMenu() prints output as expected
 * 
 ...
 * @date 2021.10
 */
public class CommandMenuTextTester {
   ...
   */
  public CommandMenuTextTester(String programInput, ShowSearcherFrontend frontend) {
