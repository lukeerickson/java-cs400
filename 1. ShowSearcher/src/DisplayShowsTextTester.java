...
/**
 * Based on TextUITester by Gary Dahl
 * Checks to see that displayShows() prints output as expected
 * 
 ...
 * @date 2021.10
 */
public class DisplayShowsTextTester {

  ShowSearcherFrontend frontend;
   ...
   * a (lower case) 'q'.
   */
  public void run(List<IShow> shows) {
   ...
   */
  public DisplayShowsTextTester(String programInput, ShowSearcherFrontend frontend) {
